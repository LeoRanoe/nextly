  ...
  return (
    <SettingsSheet
      initial={{
        ...
        sameDayPickupEnabled: settings?.sameDayPickupEnabled ?? false,
        pickupCutoffTime: settings?.pickupCutoffTime ?? '',
        deliveryEnabled: settings?.deliveryEnabled ?? false,
        deliveryDetails: settings?.deliveryDetails ?? '',
        deliveryAreas: settings?.deliveryAreas ?? '',
        deliveryFeeDisplay: settings?.deliveryFeeDisplay ?? '',
        deliveryEstimateDisplay: settings?.deliveryEstimateDisplay ?? '',
        ...
        defaultNewArrivalDays: settings?.defaultNewArrivalDays ?? 30,
        homepageAvailableNowEnabled: settings?.homepageAvailableNowEnabled ?? true,
        homepageAvailableNowLimit: settings?.homepageAvailableNowLimit ?? 6,
        homepageFeaturedBundlesEnabled: settings?.homepageFeaturedBundlesEnabled ?? true,
        homepageFeaturedBundlesLimit: settings?.homepageFeaturedBundlesLimit ?? 3,
        homepageJustArrivedEnabled: settings?.homepageJustArrivedEnabled ?? true,
        homepageJustArrivedLimit: settings?.homepageJustArrivedLimit ?? 4,
        homepageComingNextEnabled: settings?.homepageComingNextEnabled ?? true,
        homepageComingNextLimit: settings?.homepageComingNextLimit ?? 4,
      }}
    />
  );
}
